    ...
    class Program
    {
        ...
        static void taskStrings()
        {
           ...
           Console.WriteLine(H == F); //true   */
            ...
            string app = "Hello!";
            string app2 = "My name is JoJo,  ";
            int num = 15;
            sb.Append('—', num);
            sb.AppendLine(app);
            sb.AppendLine(app2);
            sb.Remove(15, app.Length);
            sb.Insert(app2.Length + num + 1, app);
        ...
        {
            (int, string, char, string, ulong) tuple = (666, "Джайро", '!', "Цепелли", 2048);
